...
def parse_args():
    ...
    args.add_argument("--pixelate-size", dest="pixelate_size", type=float, default=5, help="Raster size of pixelated effect. The low the value, the more blocks are generated. Only working when mode is pixelate")
